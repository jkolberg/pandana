...
Pandana is easiest to install in Python 3.10 to 3.12 with pandas 2.3+. The last version of Pandana with Python 2.7 binaries is v0.4.4 on Conda Forge. The last version with Python 3.5 binaries is v0.6 on Pip.
